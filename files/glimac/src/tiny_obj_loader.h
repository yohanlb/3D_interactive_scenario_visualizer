...
typedef struct material_t
{
	...
	dissolve(0),
	illum(0),
	ambient_texname(std::string()),
	diffuse_texname(std::string()),
	specular_texname(std::string()),
	normal_texname(std::string()),
	unknown_parameter(std::map<std::string, std::string>()) {}
